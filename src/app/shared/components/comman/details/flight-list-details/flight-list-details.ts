...
export class FlightListDetails {
  ...
  removeTag(value: string) {
    ...
    this.getArrivalTimeParams = this.getArrivalTimeParams.filter(
      (arrival_time: string) => arrival_time != value,
    );
    this.getDepartureTimeParams = this.getDepartureTimeParams.filter(
      (departure_time: string) => departure_time != value,
    );
    ...
    let params = {
      ...
      departure_time: this.getDepartureTimeParams.length
        ? this.getDepartureTimeParams.join(',')
        : null,
    };
