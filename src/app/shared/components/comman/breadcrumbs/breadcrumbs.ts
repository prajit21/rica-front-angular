...
@Component({
    ...
    imports: [HotelBreadcrumb, HotelBreadcrumbTitle, TourBreadcrumb, TourBreadcrumbSinglePage, FlightBreadcrumb, CabBreadcrumb, RestaurantBreadcrumb, RestaurantSinglePageBreadcrumb, PagesBreadcrumb]
})
