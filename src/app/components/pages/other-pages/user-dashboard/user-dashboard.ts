...
@Component({
    ...
    imports: [Header, Breadcrumbs, UserDashboardTab, UserDashboardDetails, UserDashboardProfile, UserDashboardBooking, UserDashboardCards, UserDashboardBookmark, UserDashboardSecurity, Footer, Layout]
})
