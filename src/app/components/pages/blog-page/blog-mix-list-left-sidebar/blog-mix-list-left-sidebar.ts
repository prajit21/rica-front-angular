...
@Component({
  selector: 'app-blog-mix-list-left-sidebar',
  templateUrl: './blog-mix-list-left-sidebar.html',
  styleUrl: './blog-mix-list-left-sidebar.scss',
  imports: [Header, Breadcrumbs, BlogFilter, BlogList, Footer, Layout],
})
export class BlogMixListLeftSidebar {
