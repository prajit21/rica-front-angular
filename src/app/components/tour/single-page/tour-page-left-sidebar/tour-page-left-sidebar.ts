...
@Component({
    ...
    templateUrl: './tour-page-left-sidebar.html',
    styleUrl: './tour-page-left-sidebar.scss',
    imports: [Header, Breadcrumbs, TourSinglePageFilter, TourTabs, TourHighlight, TourItinerary, TourGallery, TourAccommodation, TourLocation, TourReview, TourPolicy, TourGallerySlider, TourSinglePageModal, Footer, Layout]
})
export class TourPageLeftSidebar {
