...
@Component({
    selector: 'app-hotel-page-info-tab',
    templateUrl: './hotel-page-info-tab.html',
    styleUrls: ['./hotel-page-info-tab.scss'],
    imports: [Header, HotelTitleSection, HotelGallery, HotelTabSlider, HotelAbout, HotelRooms, HotelFacility, HotelLocation, HotelReview, HotelPolicy, SinglePageHotels, HotelSinglePageFilter, HotelSinglePageModal, Footer, Layout]
})
export class HotelPageInfoTab {
