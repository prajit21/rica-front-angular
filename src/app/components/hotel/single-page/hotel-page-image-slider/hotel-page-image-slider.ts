...
import { HotelImageSlider } from '../widgets/hotel-image-slider/hotel-image-slider';
import { Header } from '../../../../shared/components/header/header';

@Component({
    selector: 'app-hotel-page-image-slider',
    templateUrl: './hotel-page-image-slider.html',
    styleUrls: ['./hotel-page-image-slider.scss'],
    imports: [Header, HotelImageSlider, HotelTitleSection, HotelTabSlider, HotelAbout, HotelRooms, HotelFacility, HotelLocation, HotelReview, HotelPolicy, SinglePageHotels, HotelSinglePageFilter, HotelSinglePageModal, Footer, Layout]
})
export class HotelPageImageSlider {
