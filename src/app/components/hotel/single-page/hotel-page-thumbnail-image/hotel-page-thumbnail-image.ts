...
import { HotelThumbnailImages } from '../widgets/hotel-thumbnail-images/hotel-thumbnail-images';
...
@Component({
    ...
    templateUrl: './hotel-page-thumbnail-image.html',
    styleUrls: ['./hotel-page-thumbnail-image.scss'],
    imports: [Header, HotelTitleSection, HotelThumbnailImages, HotelTabSlider, HotelAbout, HotelRooms, HotelFacility, HotelLocation, HotelReview, HotelPolicy, SinglePageHotels, HotelSinglePageFilter, HotelSinglePageModal, Footer, Layout]
})
export class HotelPageThumbnailImage {
