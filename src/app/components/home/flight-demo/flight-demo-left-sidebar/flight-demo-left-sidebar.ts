...
@Component({
    ...
    imports: [Header, FlightLeftSidebarHomeSection, FlightLeftSidebar, FlightLeftSidebarAirlineDetails, FlightLeftSidebarAirlineDestination, FlightLeftSidebarAirlineDeals, Footer, Layout]
})
