...
@Component({
    ...
    imports: [Header, TourVectorHomeSection, TourVectorExploreThemes, TourVectorBooking, TourVectorPopularDestination, TourVectorBanner, TourVectorBlog, TourVectorSubscribe, Footer, Layout]
})
