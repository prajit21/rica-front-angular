...
@Component({
    ...
    imports: [Header, RestaurantMinimalHomeSection, RestaurantMinimalCategory, RestaurantMinimalBanner, RestaurantMinimalBooking, RestaurantMinimalPopularRestaurant, RestaurantMinimalApplication, Footer, Layout]
})
