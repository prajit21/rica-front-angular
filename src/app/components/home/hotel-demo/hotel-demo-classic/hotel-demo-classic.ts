...
@Component({
    ...
    imports: [Header, HotelClassicHomeSection, HotelClassicAboutHotel, HotelClassicTicketSection, HotelClassicGallery, HotelClassicSpecialRooms, HotelClassicVideo, HotelClassicService, HotelClassicSubscribe, HotelClassicTestimonial, HotelClassicSocialGallery, Footer, Layout]
})
